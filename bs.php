...
#设置入口文件对应目录
define('APP_PATH', 'BackworkStation/');

###############自定义路径
define('W_ROOT', '/BackworkStation/Common/Public/');#根公共路径
...
define('W_PUBLIC_WECHAT', '/Public/Wechat/');#微信公共资源
define('W_PUBLIC_COMPANY', '/Public/Company/');#公司公共资源

define('P_ROOT', './BackworkStation/Common/Public/');#根公共路径
...
define('P_PUBLIC_GOODS_IMG', './Public/Goods/Img/');#商品公共图片路径
define('P_PUBLIC_IMG', './Public/Img/');#公共图片
define('P_PUBLIC_WECHAT', './Public/Wechat/');#微信公共资源
define('P_PUBLIC_COMPANY', './Public/Company/');#公司公共资源
###############自定义路径<FINISH>
