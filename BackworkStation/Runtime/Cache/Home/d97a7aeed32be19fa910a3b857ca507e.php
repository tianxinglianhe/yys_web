	...
	<div class="row">
		...
		<div class="row">
			<div class="col-sm-3">
				...
				<form class="input-group input-group-sm" style="margin-top: 5px;" action="<?php echo U('home/goods/update');?>" method="get">
			...
			<div class="col-sm-9">
				...
				<nav>
					<ul class="pagination">
						<li>
							<a href="<?php echo U('home/goods/update');?>?page_now=<?php echo ($_SESSION['bs']['limitPage']['pageNow']-1); ?>" aria-label="Previous">
								<span aria-hidden="true" class="glyphicon glyphicon-chevron-left"></span>
							</a>
						</li>
						<?php for($i=1;$i<=$_SESSION['bs']['limitPage']['pageMax'];$i++): ?>
						<?php if($i==$_SESSION['bs']['limitPage']['pageNow']): ?>
						<li><a href="<?php echo U('home/goods/update');?>?page_now=<?php echo ($i); ?>&type=<?php echo ($_GET['type']); ?>"><strong style="color:red;"><?php echo ($i); ?></strong></a></li>
						<?php else: ?>
						<li><a href="<?php echo U('home/goods/update');?>?page_now=<?php echo ($i); ?>&type=<?php echo ($_GET['type']); ?>"><?php echo ($i); ?></a></li>
						<?php endif; ?>
						<?php endfor; ?>
						<li>
							<a href="<?php echo U('home/goods/update');?>?page_now=<?php echo ($_SESSION['bs']['limitPage']['pageNow']-1); ?>" aria-label="Next">
