...
<div class="container">
	<div class="row">
		<form id="formJoinCart">
			<input type="hidden" name="id" value="<?php echo ($goodsDetailInfo['id']); ?>">
			<div class="col-md-5">
				<img src="<?php echo W_PUBLIC_GOODS_IMG; echo ($goodsDetailInfo['id']); ?>/<?php echo ($goodsDetailInfo['img']); ?>" alt="" width="100%">
			</div>
			<div class="col-md-7">
				<div class="row">
					<h3 class="text-muted">
						<?php echo ($goodsDetailInfo['name']); ?>
						<br>
						<small class="text-danger"><?php echo ($goodsDetailInfo['explain']); ?></small>
					</h3>
				</div>
				<div class="row well">
					<div class="col-md-8">
						<h4>价格：￥<?php echo ($goodsDetailInfo['price']); ?></h4>
						<h4>
							<del>价格：￥<?php echo ($goodsDetailInfo['price']); ?></del>
						</h4>
						<h3 class="text-danger">特价：￥<?php echo ($goodsDetailInfo['sale_price']); ?></h3>
					</div>
					<div class="col-md-4">
						<a href="#">联系客服</a>
					</div>
				...
				<div class="row">
					<h5 class="text-muted">供货地区：<?php echo ($_SESSION['sys']['userIpInfo']['city']); ?></h5>
					<hr>
					<dl class="dl-horizontal">
						<dt>选择规格：</dt>
						<?php foreach($normsInfo as $item): ?>
						<dd>
							<input type="radio" name="f_norms_id" value="<?php echo ($item['id']); ?>" id="radFNormsId<?php echo ($item['id']); ?>">
							<label for="radFNormsId<?php echo ($item['id']); ?>"><?php echo ($item['name']); ?></label>
						</dd>
						<?php endforeach; ?>
					</dl>
				</div>
...
<script language="javascript" type="text/javascript" charset="utf-8">
	$('#btnJoinCart').on('click', null, null, function () {
		$.ajax({
			url: '<?php echo U("home/goods/ajaxJoinCart");?>',
			type: 'post',
