...
<div class="container">
	...
	<div class="carousel-inner" role="listbox">
		...
		<div class="item">
			<img src="<?php echo W_ROOT_IMG;?>banner2.jpg" alt="..." style="width: 100%;">
			<div class="carousel-caption">
			</div>
		</div>
		<div class="item">
			<img src="<?php echo W_ROOT_IMG;?>banner3.jpg" alt="..." style="width: 100%;">
			<div class="carousel-caption">
			</div>
		</div>
		<div class="item">
			<img src="<?php echo W_ROOT_IMG;?>banner4.jpg" alt="..." style="width: 100%;">
			<div class="carousel-caption">
			</div>
		</div>
	</div>
