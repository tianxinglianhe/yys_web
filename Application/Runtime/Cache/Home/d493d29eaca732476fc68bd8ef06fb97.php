				...
				<div class="row">
					<div class="col-lg-12">
						<a href="<?php echo U('home/goods/detail');?>?id=<?php echo ($item['id']); ?>">
							<img src="<?php echo W_ROOT_IMG;?>cut3.jpg" alt="$item['name']" width="100%">
						</a>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-8">
						<p class="text-left"><?php echo a4admixStrsub($item['name']);?></p>
					</div>
					<div class="col-lg-4">
						<p class="text-right">
							<span style="color: orangered;"><?php echo ($item['price']); ?></span>
							<br>
							库存：<?php echo ($item['inventory']); ?>
						</p>
					</div>
				</div>
			</div>
