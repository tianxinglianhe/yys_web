...
<!-- <nav class="navbar navbar-default">
 ...
 -->
 	<!-- 1级导航固定顶部 黑色navbar-fixed-top navbar-inverse-->
<nav class="navbar navbar-default  navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">易优速</a>
    </div>
		<!-- 当前地区 -->
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav navbar-left">
     ...
     <!--  <form class="navbar-form navbar-left" role="search">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="#">热门推荐</a></li>
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">优惠活动<span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="#">某某某</a></li>
            <li><a href="#">某某某</a></li>
            <li><a href="#">某某某</a></li>
       ...
       <ul class="nav navbar-nav navbar-right">
        <li><a href="#">登录</a></li>
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">咨询<span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="#">某某某</a></li>
            <li><a href="#">某某某</a></li>
            <li><a href="#">某某某</a></li>
...
<div class="row">
  ...
  <div class="col-md-7">
  	<ul class="nav navbar-nav navbar-left ">
			...
			<li class="dropdown">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">热门推荐XX <span class="caret"></span></a>
				<ul class="dropdown-menu">
					<li><a href="<?php echo U('home/homeAppliances/homeAppliances');?>?goodsTypeName=居家用品">居家用品</a></li>
				</ul>
			</li>
	...
	<div class="row">
		...
		<div class="col-md-4">
			<nav>
				<ul class="pagination">
					<li>
						<a href="<?php echo U('home/amusementAndKeepHealth/scouringBathCommonGoods');?>?goodsTypeName=<?php echo ($_SESSION['sys']['limitPage']['goodsTypeName']); ?>&pageNow=<?php echo ($_SESSION['sys']['limitPage']['pageNow']-1); ?>" aria-label="Previous">
							<span aria-hidden="true">&laquo;</span>
						</a>
					</li>
					<?php for($i=1;$i<=$_SESSION['sys']['limitPage']['pageMax'];$i++): ?>
					<?php if($i==$_SESSION['sys']['limitPage']['pageNow']): ?>
					<li><a href="<?php echo U('home/amusementAndKeepHealth/scouringBathCommonGoods');?>?goodsTypeName=<?php echo ($_SESSION['sys']['limitPage']['goodsTypeName']); ?>&pageNow=<?php echo ($i); ?>"><strong style="color: orangered;"><?php echo ($i); ?></strong></a></li>
					<?php else: ?>
					<li><a href="<?php echo U('home/amusementAndKeepHealth/scouringBathCommonGoods');?>?goodsTypeName=<?php echo ($_SESSION['sys']['limitPage']['goodsTypeName']); ?>&pageNow=<?php echo ($i); ?>"><?php echo ($i); ?></a></li>
					<?php endif; ?>
					<?php endfor; ?>
					<li>
						<a href="<?php echo U('home/amusementAndKeepHealth/scouringBathCommonGoods');?>?goodsTypeName=<?php echo ($_SESSION['sys']['limitPage']['goodsTypeName']); ?>&pageNow=<?php echo ($_SESSION['sys']['limitPage']['pageNow']+1); ?>" aria-label="Next">
