	...
	<div class="row">
		...
		<div class="col-md-4">
			<nav>
				<ul class="pagination">
					<li>
						<a href="<?php echo U('home/hotelWineshop/repayableGoods');?>?goodsTypeName=<?php echo ($_SESSION['sys']['limitPage']['goodsTypeName']); ?>&pageNow=<?php echo ($_SESSION['sys']['limitPage']['pageNow']-1); ?>" aria-label="Previous">
							<span aria-hidden="true">&laquo;</span>
						</a>
					</li>
					<?php for($i=1;$i<=$_SESSION['sys']['limitPage']['pageMax'];$i++): ?>
					<?php if($i==$_SESSION['sys']['limitPage']['pageNow']): ?>
					<li><a href="<?php echo U('home/hotelWineshop/repayableGoods');?>?goodsTypeName=<?php echo ($_SESSION['sys']['limitPage']['goodsTypeName']); ?>&pageNow=<?php echo ($i); ?>"><strong style="color: orangered;"><?php echo ($i); ?></strong></a></li>
					<?php else: ?>
					<li><a href="<?php echo U('home/hotelWineshop/repayableGoods');?>?goodsTypeName=<?php echo ($_SESSION['sys']['limitPage']['goodsTypeName']); ?>&pageNow=<?php echo ($i); ?>"><?php echo ($i); ?></a></li>
					<?php endif; ?>
					<?php endfor; ?>
					<li>
						<a href="<?php echo U('home/hotelWineshop/repayableGoods');?>?goodsTypeName=<?php echo ($_SESSION['sys']['limitPage']['goodsTypeName']); ?>&pageNow=<?php echo ($_SESSION['sys']['limitPage']['pageNow']+1); ?>" aria-label="Next">
